...
Realm.init(this);
    ...
    private void showUpdateDialog() {
        final AlertDialog.Builder al=new AlertDialog.Builder(CRUD.this);
    ...
    private void ShowDeleteDialog() {
        AlertDialog.Builder al=new AlertDialog.Builder(CRUD.this);
        View view=getLayoutInflater().inflate(R.layout.delete_dialog,null);
        al.setView(view);
...
///////
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("insert check", "onClick: its reaching");
